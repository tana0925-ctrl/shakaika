    ...
    <table id="tableElem">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="lesson_practice" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">対話で成り立つ授業を</span><p>教師からの一方通行でなく、子ども同士の対話で成り立つ授業を展開してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="research" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">理論を磨き合う</span><p>自分の実践を理論づけ、より良い実践になるように議論し、理論を磨き合いたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr class="row-action">
    ...
    <table id="tableJunior" style="display:none">
      ...
      <tbody>
        <tr>
          ...
          <td class="col-step" data-vp="j_lesson_plan" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">生徒の「なぜ？」をうむ</span><p>生徒が「なぜ？」と自然と問いを持てるような教材を仕掛け、社会的な見方・考え方を働かせる授業を構想してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">足でかせいでアレンジ</span><p>先輩の基本型を参考にしながら、身近な地域の事例や時事問題を「足でかせいで」仕入れ、生徒の実態に合わせてアレンジしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">単元を自分でつくる</span><p>自分で足を使って教材を発掘し、ほかの分野の見方・考え方を生かしたオリジナルの単元を構想・提案してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          ...
          <td class="col-step" data-vp="j_material" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">複数資料を比較・関連付ける</span><p>地図とグラフ、異なる立場の史料など複数の資料を比較・関連付けさせ、生徒の「なぜ？」を引き出してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_material" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">多様な資料を足で集める</span><p>新聞記事（NIE）や最新の統計データなど、多様な資料を足で稼いで集め、提示を工夫してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="j_dialogue" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">根拠を持って意見を出し合う</span><p>異なる意見をもつ立場で話し合い、根拠を持って意見を出し合ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="j_inquiry" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">高度な探究をデザインする</span><p>現代社会にみられる課題に対して、生徒が自ら問いを立てて解決策を模索する高度な探究をデザインしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
    ...
    <table id="tableAdmin" style="display:none">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="a_outreach" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">外部講師や連携先を紹介する</span><p>大学の先生や他地区の優れた先生など、管理職のネットワークを活かして会に紹介してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_outreach" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">自分の経験を語る</span><p>自分がこれまで積み重ねた社会科の授業づくりの経験や学校経営の知見を、講演や寄稿で次世代に伝えてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea></td>
