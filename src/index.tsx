    ...
    <table id="tableAdmin" style="display:none">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="a_member_support" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">論文・記録の方向性を一緒に考える</span><p>「何を書きたいか」を整理し、実践記録や論文の方向づけを手伝ってみたい。</p><span class="keyword" style="display:block;margin-top:6px;padding-top:6px;border-top:1px dashed #e0c080">手立ての有効性や検証方法を相談する</span></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea><div class="memo-hint">例：試していること、困っていること等</div></td>
