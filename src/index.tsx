    ...
    <table id="tableElem">
      ...
      <tbody>
        <tr>
          ...
          <td class="col-step" data-vp="lesson_plan" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">基本型をまねる</span><p>教科書や既存の資料を使って、基本的な授業を構成してみたい。まずはここから。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_plan" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">足でかせいでアレンジ</span><p>先輩の基本型を参考にしながら、名古屋の身近な話題や地域を「足でかせいで」集めた教材で、目の前の子どもに合わせてアレンジしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_plan" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">子どもの「なぜ？」をうむ</span><p>子どもが「なぜ？」と思わず問いたくなる教材を仕掛け、<span class="ss-term">社会的な見方・考え方</span>を働かせる授業を構想してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_plan" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">単元を自分でつくる</span><p>自分で足を使って教材や場所とつながりながら、オリジナルの単元を構想・提案してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>授業をする</div><div style="font-size:9px;color:#888;margin-top:2px">実践・対話</div></td>
          <td class="col-step" data-vp="lesson_practice" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">楽しい授業をする</span><p>まずは子どもが楽しめる授業をしてみたい。笑顔や「もっとやりたい！」が生まれたらOK！</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_practice" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">子どもが動く活動へ</span><p>調べ学習やグループワークなど、子どもが自ら動く「活動」を取り入れてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_practice" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">見方・考え方を働かせる</span><p>単なる活動で終わらせず、<span class="ss-term">社会的な見方・考え方</span>を働かせる授業を意識してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="lesson_practice" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">対話で成り立つ授業を</span><p>教師からの一方通行でなく、子ども同士の対話で成り立つ授業を展開してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>子どもを見る</div><div style="font-size:9px;color:#888;margin-top:2px">観察・評価</div></td>
          <td class="col-step" data-vp="student_eval" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">まずザックリ観察する</span><p>最初はザックリでOK！授業中の子どもの姿や声に目を向けてみたい。「楽しそう？」「困っている？」を感じ取るところから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="student_eval" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">「わかった」を言葉にさせる</span><p>ノートや発言から「この子はここまでわかっているかな？」とのぞいてみたい。「わかった」を自分の言葉で表現できる場を、気負わずに作ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="student_eval" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">点数にならない良さを見つける</span><p>正解・不正解だけでなく、粘り強く考えを表現しようとしている姿など、点数になりにくい良さをそっと認めてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="student_eval" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">子どもの姿で授業を問い直す</span><p>「この子たちの反応は、自分の授業への答えだ」と捉え、子どもの姿を元に授業を再構成してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          ...
          <td class="col-step" data-vp="connection" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">場に参加する</span><p>同好会に入会し、イベントや例会に参加してみたい。同期や先輩と顔見知りになれたらOK！</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="connection" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">横のつながりを作る</span><p>同期など、横のつながりを作り、話しやすい関係を築いてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="connection" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">縦のつながりを作る</span><p>先輩や役員など、縦のつながりを作り、授業実践について教えを請うてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="connection" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">仲間を支える側に回る</span><p>悩みや本音を語り合える仲間を持ち、時には仲間を支える側に回ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          ...
          <td class="col-step" data-vp="research" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">参加を楽しむ</span><p>同好会の雰囲気を知り、まずは参加を楽しんでみたい。「こんな世界があるんだ！」と感じることから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="research" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">インプット・刺激を受ける</span><p>先輩たちの実践記録を読んでインプットし、刺激を受けたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="research" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">実践をアウトプット</span><p>自分の実践を<span class="ss-term">「体験記録」</span>として書き、アウトプットしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="research" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">理論を磨き合う</span><p>自分の実践を理論づけ、より良い実践になるように議論し、理論を磨き合いたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr class="row-action">
    ...
    <table id="tableJunior" style="display:none">
      ...
      <tbody>
        <tr>
          ...
          <td class="col-viewpoint"><div>授業をつくる</div><div style="font-size:9px;color:#888;margin-top:2px">教材研究・構成</div></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">基本型をまねる</span><p>教科書や既存の資料を参考にしながら、地理・歴史・公民の基本的な授業を構成してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">生徒の「なぜ？」をうむ</span><p>生徒が「なぜ？」と自然と問いを持てるような教材を仕掛け、社会的な見方・考え方を働かせる授業を構想してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">足でかせいでアレンジ</span><p>先輩の基本型を参考にしながら、身近な地域の事例や時事問題を「足でかせいで」仕入れ、生徒の実態に合わせてアレンジしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_lesson_plan" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">単元を自分でつくる</span><p>自分で足を使って教材を発掘し、ほかの分野の見方・考え方を生かしたオリジナルの単元を構想・提案してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>【資料】</div><div style="font-size:9px;color:#888;margin-top:2px">読み解く・提示する</div></td>
          <td class="col-step" data-vp="j_material" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">基本資料を読み解く</span><p>教科書の図版や基本資料を読み解き、授業の基本の流れに組み込んでみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_material" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">複数資料を比較・関連付ける</span><p>地図とグラフ、異なる立場の史料など複数の資料を比較・関連付けさせ、生徒の「なぜ？」を引き出してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_material" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">多様な資料を足で集める</span><p>新聞記事（NIE）や最新の統計データなど、多様な資料を足で稼いで集め、提示を工夫してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_material" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">生徒が主体的に資料を読む</span><p>生徒自身が目的に応じて資料を見つけ出し、多面的・多角的に読み解く力を育ててみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>【対話】</div><div style="font-size:9px;color:#888;margin-top:2px">意見を交わす・議論する</div></td>
          <td class="col-step" data-vp="j_dialogue" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">つぶやきを拾って広げる</span><p>生徒の些細なつぶやきや疑問を丁寧に拾い、学級全体に広げることから始めてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_dialogue" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">自分の考えを言葉にする場を作る</span><p>ペアやグループワークを効果的に取り入れ、自分の考えを言葉にして伝え合う場を作ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_dialogue" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">根拠を持って意見を出し合う</span><p>異なる意見をもつ立場で話し合い、根拠を持って意見を出し合ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_dialogue" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">合意形成に向かう対話を支援する</span><p>生徒同士の対話から新たな価値観を生み出し、社会的な合意形成に向かう話し合いを支援してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>【探究】</div><div style="font-size:9px;color:#888;margin-top:2px">問いを立てる・追究する</div></td>
          <td class="col-step" data-vp="j_inquiry" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">調べる・まとめる時間を確保する</span><p>授業の中で、基礎的な知識を「調べる」「まとめる」時間をしっかり確保することから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_inquiry" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">自分ごとして調べる学習を仕掛ける</span><p>ICTを活用したり、身近な地域の事象と結びつけたりして、生徒が自分ごととして調べる学習を仕掛けてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_inquiry" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">「大きな問い」で探究サイクルを作る</span><p>単元を貫く「大きな問い」を設定し、生徒が主体的に探究し続けるサイクルを作ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_inquiry" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">高度な探究をデザインする</span><p>現代社会にみられる課題に対して、生徒が自ら問いを立てて解決策を模索する高度な探究をデザインしてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>生徒を見る</div><div style="font-size:9px;color:#888;margin-top:2px">観察・評価</div></td>
          <td class="col-step" data-vp="j_student_eval" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">まずザックリ観察する</span><p>最初はザックリでOK！授業中の生徒の表情や発言に目を向け、「理解できてる？」「関心がある？」を感じ取るところから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_student_eval" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">「わかった」を言葉にさせる</span><p>ノートや発言からの理解を確認しながら、「わかった」を自分の言葉で表現できる場を気負わずに作ってみたい。毎時間できなくてOK！</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_student_eval" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">点数にならない良さを見つける</span><p>正解・不正解だけでなく、粘り強く考えた過程や多面的な視点など、点数になりにくい良さをそっと認めてみたい。その気づきが、次の問いにつながる。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_student_eval" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">生徒の姿で授業を問い直す</span><p>「この生徒たちの反応は、自分の授業への答えだ」と捉え、生徒を元に授業を再構成してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-category cat-connect">仲間<br>活動</td>
          <td class="col-viewpoint"><div>つながる</div><div style="font-size:9px;color:#888;margin-top:2px">仲間・同僚性</div></td>
          <td class="col-step" data-vp="j_connection" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">場に参加する</span><p>同好会に入会し、イベントや会に参加してみたい。同期や先輩と顔見知りになれたらOK！</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_connection" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">横のつながりを作る</span><p>同期など、同校・近隣校の先生と横のつながりを作り、気軽に話しやすい関係を築いてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_connection" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">縦のつながりを作る</span><p>先輩や役員など、縦のつながりを作り、授業実践について教えを請うてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_connection" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">仲間を支える側に回る</span><p>悩みや本音を語り合える仲間を持ち、時には仲間を支える側に回ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-category cat-research">研究<br>発信</td>
          <td class="col-viewpoint"><div>深める</div><div style="font-size:9px;color:#888;margin-top:2px">研究・発信</div></td>
          <td class="col-step" data-vp="j_research" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">参加を楽しむ</span><p>同好会の雰囲気を知り、まずは参加を楽しんでみたい。「こんな世界があるんだ！」と感じることから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="j_research" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">インプット・刺激を受ける</span><p>中学地理・歴史・公民に関する先輩たちの実践記録を読んでインプットし、刺激を受けたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          ...
          <td class="col-step" data-vp="j_research" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">理論を磨き合う</span><p>自分の実践を理論づけ、部員に向けて議論し、理論を磨き合いたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr class="row-action">
          <td colspan="2" style="text-align:right;font-weight:bold;padding-right:20px;color:#e65100"><i class="fas fa-shoe-prints"></i> おすすめのアクション</td>
          <td><ul class="action-list"><li><strong>若手交流会</strong>で仲間作り</li><li><strong>授業づくり講座</strong>を聞く</li><li><strong>懇親会</strong>にとりあえず行く</li></ul></td>
    ...
    <table id="tableAdmin" style="display:none">
      ...
      <tbody>
        <tr>
          ...
          <td class="col-step" data-vp="a_school_support" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">例会に顔を出す</span><p>まずは例会やイベントに参加して、場の雰囲気づくりに協力するところから始めてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_support" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">例会の学びを深める</span><p>授業検討会などで、管理職としての経験を活かした助言や問いかけで学びを深めてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_support" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">研究会の内容充実に関わる</span><p>授業検討会やフィールドワークの企画に関わり、会の学びの質を高めることに貢献したい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_support" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">会の学びの文化を守る</span><p>同好会が大切にしてきた「授業で語り合う」文化を次の世代にも伝え、学びの質を守りたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>会員同士をつなぐ</div><div style="font-size:9px;color:#888;margin-top:2px">交流・居場所づくり</div></td>
          <td class="col-step" data-vp="a_school_mgmt" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">声をかける</span><p>例会で一人でいる会員や新しい会員に声をかけ、「来てよかった」と思える安心感を生みたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_mgmt" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">世代をつなぐ</span><p>ベテランと若手の橋渡し役として、会員同士が気軽に話せる関係づくりを促してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_mgmt" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">学び合いの場をつくる</span><p>会員同士が実践を見合ったり、気軽に相談し合えるような関係性やグループをつくりたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_school_mgmt" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">会の一体感を育てる</span><p>会員みんなが「ここが自分の居場所だ」と思える温かい雰囲気をつくり、会の一体感を育てたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          ...
          <td class="col-step" data-vp="a_member_support" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">実践記録を読んで感想を伝える</span><p>会員が書いた実践記録や体験記録を読み、「ここが面白い」と感想を伝えることから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_member_support" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">論文の方向性を一緒に考える</span><p>「何を書きたいか」を一緒に整理し、論文や実践記録の方向づけを手伝ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_member_support" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">論文を書き上げるまで伴走する</span><p>構成から推敲まで、会員が論文を完成させるまで粘り強く伴走してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_member_support" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">書く文化を会に根づかせる</span><p>「書いてみようかな」と思える雰囲気をつくり、会員同士が互いの原稿を読み合う文化を育てたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>次世代リーダーを育てる</div><div style="font-size:9px;color:#888;margin-top:2px">後進育成</div></td>
          <td class="col-step" data-vp="a_leader_dev" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">若手の話を聞く</span><p>若手会員の悩みや思いに耳を傾け、「聞いてもらえる存在」になることから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_leader_dev" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">役割を任せてみる</span><p>例会やイベントの一部を若手に任せ、経験を積ませる場をつくってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_leader_dev" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">一緒に企画・運営する</span><p>大きなイベントや研究大会の企画を若手と一緒に進め、運営のノウハウを伝えたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_leader_dev" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">任せて見守る</span><p>次世代のリーダーに中心を譲り、困ったときだけ支える「見守る」立場で関わりたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          ...
          <td class="col-step" data-vp="a_org_mgmt" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">例会に参加して助言する</span><p>例会や研究会に参加し、管理職の視点から率直な感想や助言を伝えてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_org_mgmt" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">会の方向性を一緒に考える</span><p>役員会などで会の今後の方向性やテーマについて、自分の意見を積極的に出してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_org_mgmt" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">大会・イベントの運営を支える</span><p>研究大会やフィールドワークの運営面で、管理職としての経験や人脈を活かして調整役を担ってみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_org_mgmt" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">会の未来を描く</span><p>5年後・10年後の会の姿を構想し、持続可能な組織づくりの道筋をつくりたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr>
          <td class="col-viewpoint"><div>外とつなぐ・知見を還元する</div><div style="font-size:9px;color:#888;margin-top:2px">対外連携・還元</div></td>
          <td class="col-step" data-vp="a_outreach" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">他の研究会の情報を持ち帰る</span><p>管理職の集まりや他教科の研究会で得た情報を、同好会に持ち帰って共有してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_outreach" data-step="2" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">外部講師や連携先を紹介する</span><p>大学の先生や他地区の優れた先生など、管理職のネットワークを活かして会に紹介してみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_outreach" data-step="3" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">自分の経験を語る</span><p>自分がこれまで積み重ねた社会科の授業づくりの経験や学校経営の知見を、講演や寄稿で次世代に伝えてみたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
          <td class="col-step" data-vp="a_outreach" data-step="4" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">社会科教育の価値を広める</span><p>管理職の立場から社会科教育の重要性を周囲に発信し、名古屋の社会科の文化を守り育てたい。</p></div><textarea class="memo-input" rows="2" placeholder="例：最近この観点で試していることや困っていること" onclick="event.stopPropagation()"></textarea></td>
        </tr>
        <tr class="row-action">
          <td colspan="2" style="text-align:right;font-weight:bold;padding-right:20px;color:#e65100"><i class="fas fa-shoe-prints"></i> おすすめのアクション</td>
