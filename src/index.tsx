    ...
    <table id="tableElem">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="col-step" data-vp="research" data-step="1" onclick="selectCell(this)"><div class="cell-content"><span class="keyword">参加を楽しむ</span><p>同好会の雰囲気を知り、まずは参加を楽しんでみたい。「こんな世界があるんだ！」と感じることから始めたい。</p></div><textarea class="memo-input" rows="2" placeholder="メモ（任意）" onclick="event.stopPropagation()"></textarea><div class="memo-hint">例：試していること、困っていること等</div></td>
        ...
        <tr class="row-action">
          ...
          <td><ul class="action-list"><li><strong>模擬授業</strong>をやってみる</li><li><strong>FW・イベント</strong>を企画する</li><li><strong>研究部の議論</strong>に参加する</li></ul></td>
          <td><ul class="action-list"><li><strong>同好会</strong>で発表する</li><li><strong>研究紀要</strong>に書いてみる</li><li><strong>全国大会</strong>の情報をチェック</li></ul></td>
        </tr>
      </tbody>
    </table>
